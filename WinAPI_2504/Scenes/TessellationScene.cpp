...
TessellationScene::TessellationScene()
{
    ...
    edgeBuffer->GetValues()[0] = 1;
    edgeBuffer->GetValues()[1] = 1;
    edgeBuffer->GetValues()[2] = 1;
    edgeBuffer->GetValues()[3] = 1;

    insideBuffer = new FloatValueBuffer();
    insideBuffer->GetValues()[0] = 1;
    insideBuffer->GetValues()[1] = 1;
}
...
void TessellationScene::GUIRender()
{
    ...
    ImGui::DragFloat("Edge0", &edgeBuffer->GetValues()[0]);
    ImGui::DragFloat("Edge1", &edgeBuffer->GetValues()[1]);
    ImGui::DragFloat("Edge2", &edgeBuffer->GetValues()[2]);
    ImGui::DragFloat("Edge3", &edgeBuffer->GetValues()[3]);
    ImGui::DragFloat("Inside1", &insideBuffer->GetValues()[0]);
    ImGui::DragFloat("Inside2", &insideBuffer->GetValues()[1]);
}
