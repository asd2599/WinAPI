...
Vector2 Plane::GetHalfSize()
{
    float width = 110.0f * localScale.x;
    float height = 20.0f * localScale.y;
...
void Plane::MakeMesh()
{
    vertices.emplace_back(-55, -10, 1, 0, 0);
    vertices.emplace_back(-55, 10, 1, 1, 0);
    vertices.emplace_back(55, 10, 0, 1, 0);
    vertices.emplace_back(55, -10, 0, 1, 0);
